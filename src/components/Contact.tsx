export default function Contact() {
    ...
    return (
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-x-12 gap-y-8">
                <a href="mailto:codedbyjessicadotcom@gmail.com?Subject=Hello" target="_blank" className="w-20 flex flex-col items-center gap-2 text-secondaryColorDark hover:text-tertiaryColorDark group">
                ...
                <a href="https://www.linkedin.com/in/jessicazhangonline/" target="_blank" className="w-20 flex flex-col items-center gap-2 text-secondaryColorDark hover:text-tertiaryColorDark group">
                ...
                <a href="https://github.com/codedbyjessica" target="_blank" className="w-20 flex flex-col items-center gap-2 text-secondaryColorDark hover:text-tertiaryColorDark group">  
                    <svg width="30px" height="30px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg">
